  ...
  data: function () {
    return {
      ...
      adminMenuItems: [
        ...
        { path: "/user/reportlist", title: "User list" },
        { path: "/employee/employeelist", title: "Employee list" },
        { path: "/project/projectlist", title: "Project list" },
        { path: "/team/teamlist", title: "Team list" },
      ],
